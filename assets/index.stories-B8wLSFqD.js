import{r as f,R as a}from"./index-CgfFrydU.js";import{d as l}from"./styled-components.browser.esm-BDB1dcsv.js";import{n as A,g as q,d as z,e as I,f as p,i as g}from"./date-formats-DBLjY4bn.js";import"./_commonjsHelpers-CqkleIqs.js";function h(e,u,t){var y,b;const[o,n]=A(t==null?void 0:t.in,e,u),c=q(),r=c.locale??I,d=c.weekStartsOn??((b=(y=c.locale)==null?void 0:y.options)==null?void 0:b.weekStartsOn)??0,i=z(o,n);if(isNaN(i))throw new RangeError("Invalid time value");let s;i<-6?s="other":i<-1?s="lastWeek":i<0?s="yesterday":i<1?s="today":i<2?s="tomorrow":i<7?s="nextWeek":s="other";const S=r.formatRelative(s,o,n,{locale:r,weekStartsOn:d});return p(o,S,{locale:r,weekStartsOn:d})}const _=l.ol`
  display: flex;
