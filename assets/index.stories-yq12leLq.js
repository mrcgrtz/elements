import{a as e,n as t}from"./rolldown-runtime-DkW27tQK.js";import{n}from"./iframe-BCADqBzY.js";import{i as r,r as i,t as a}from"./jsx-runtime-C-bQ4dNj.js";import{C as o,S as s,b as c,c as l,i as u,l as d,r as f,s as p,u as m,w as h,x as g,y as _}from"./date-formats-nRXGbxNa.js";function v(e,t,n){let[r,i]=s(n?.in,e,t),a=o(),c=n?.locale??a.locale??d,l=n?.weekStartsOn??n?.locale?.options?.weekStartsOn??a.weekStartsOn??a.locale?.options?.weekStartsOn??0,u=_(r,i);if(isNaN(u))throw RangeError(`Invalid time value`);let f;f=u<-6?`other`:u<-1?`lastWeek`:u<0?`yesterday`:u<1?`today`:u<2?`tomorrow`:u<7?`nextWeek`:`other`;let m=c.formatRelative(f,r,i,{locale:c,weekStartsOn:l});return p(r,m,{locale:c,weekStartsOn:l})}function y(){return(y=t((()=>{m(),h(),g(),c(),l()})))()}var b,x,S,C,w,T,E,D,O,k;function A(){return(A=t((()=>{b=e(n()),r(),l(),y(),f(),x=a(),S=i.ol`
	display: flex;
